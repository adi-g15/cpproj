...
bool generate_make_project(const std::string& project_name, int cxx_standard, bool use_git ) {
    char ch;
    ...
    util::replace_all(MAKE_WORKFLOW_BOILERPLATE_, TAG_PROJECT_NAME, project_name);
