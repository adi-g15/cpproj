...
namespace git_connect {
    void init_git_repo();   // initialises a git repo in current directory
    void init_git_repo(const std::filesystem::path&);   // initialises a git repo at the target directory
